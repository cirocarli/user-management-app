                ...
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        <Link
                            ...
                            :href="$page.props.auth.user.is_admin == 1 ? route('admin.dashboard') : route('dashboard')" :active="$page.props.auth.user.is_admin == 1 ? route().current('admin.dashboard') : route().current('dashboard')"
